...
for i in topics:
    ...
    tempdf = fulldf[fulldf.top_topic == i]

    # summing tweets for all days
    Users = fulldf.groupby(['Date1'])['count'].aggregate(sum)
    ...
    # density plots
    Users.plot(kind='kde')
    plt.savefig("Graphs/Istanbul/Time_Series/density_Topic" + str(i) + ".png")

    # bar graphs
    Users.hist()
    plt.savefig("Graphs/Istanbul/Time_Series/histogram_Topic" + str(i) + ".png")
    ...
    plt.savefig("Graphs/Istanbul/Time_Series/Rolling_Average_Plots_Topic" + str(i) + ".png")
    ...
    plt.savefig("Graphs/Istanbul/Time_Series/acf_pacf_plot_Topic" + str(i) + ".png")
    ...
    plt.savefig("Graphs/Istanbul/Time_Series/Differenced_acf_pacf_plot_Topic" + str(i) + ".png")

    # lag plot
    lag_plot(Usersdiff)
    plt.savefig("Graphs/Istanbul/Time_Series/lag_plot_Topic" + str(i) + ".png")
    ...
    plt.title('Model Fit')
    plt.savefig("Graphs/Istanbul/Time_Series/fitted_plot_Topic" + str(i) + ".png")
