#### Generate HTML Pages of Shiny Apps ####
...
library(htmlwidgets)
saveWidget(widget = chi_map, file ='../Outputs/chi_languagemap.html')
saveWidget(widget = la_map, file ='../Outputs/la_languagemap.html')
saveWidget(widget = ist_map, file ='../Outputs/ist_languagemap.html')
